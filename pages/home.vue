<template>
    <div class="text-white relative font-['CoreSans-Light']">
        ...
        <transition name="switch" mode="out-in">
            <div
                v-if="menuScrollHideTargetIsVisible"
                class="fixed w-full px-20 top-10 h-[58px] flex justify-between items-center z-20"
            >
                <div
                    class="bg-[#121212] h-[58px] text-[#b5b5b5] flex w-[180px] justify-between rounded-full items-center px-[17px]"
                >
                    <div
                        class="text-[20px] transform translate-y-[3px] text-[#252525]"
                    >
                        {{ menuScrollHideTargetIsVisible }}
                    </div>
                    <svg
                        width="24"
                        height="24"
                ...
                <div class="flex items-center">
                    <button
                        ...
                        class="relative bg-[#121212] z-5 border-4 border-[#000] rounded-full w-[65px] h-[65px] flex justify-center items-center"
                    >
                        <div class="absolute w-[2px] h-[16px] bg-[#444]"></div>
                        <div
                            class="absolute w-[2px] h-[16px] bg-[#444] rotate-90"
                        ></div>
                    </button>
                    <button
                        v-if="firebaseUser"
                        @click="toggleUserMenu()"
                        class="relative z-0 rounded-full transform translate-x-4"
                    >
                        <img
                            :src="avatar"
            ...
            <div
                v-else
                class="fixed w-full justify-self-center bottom-10 h-[85px] flex justify-center items-center z-20"
            >
                <div
                    class="bg-[#ffffff07] backdrop-blur-xl w-[500px] h-full flex items-center justify-center rounded-full"
                >
                    HOHO!
                </div>
            </div>
        ...
        >
            <div class="w-screen h-screen flex justify-end">
                <div
                    class="fixed w-full px-20 top-10 h-[58px] flex justify-end items-center z-20"
                >
                    <button
                        v-if="firebaseUser"
                        @click="toggleUserMenu()"
                        class="relative bg-[#5656561b] z-5 transform -translate-x-[2px] rounded-full w-[60px] h-[60px] flex justify-center items-center"
                    >
                        <div
                            class="absolute w-[2px] h-[30px] bg-[#444] -rotate-45"
                        ></div>
                        <div
                            class="absolute w-[2px] h-[30px] bg-[#444] rotate-45"
                        ></div>
        ...
        <div
            class="h-[90vh] text-neutral-300 pb-32 pt-40 flex flex-col justify-between items-center text-2xl font-['Trap-Medium']"
        >
            <div class="flex flex-col items-center">
                <div
                    ref="menuScrollHideTarget"
                    class="font-['Poppins'] font-thin tracking-wide h-[80px] flex flex-row justify-center items-center text-[85px]"
                >
                ...
                <div
                    class="text-[16px] pb-2 font-['Poppins'] font-extralight tracking-wide"
                >
                    {{ dateDay }}, {{ dateMonth }} {{ dateDayNum }}
                </div>
                <p class="pt-4 text-[25px]">
                    <span class="font-['Poppins'] font-thin">{{
                        greeting
                    }}</span
                    ><span>{{ name }}</span
                    ><span> 👋</span>
            ...
            <!-- Widgets -->
            <div
                class="w-[100%] scroll-smooth flex justify-center no-scrollbar items-center overflow-x-hidden h-[310px]"
            >
                <transition name="fadein" mode="out-in">
                    <div
                        ref="scrollcenter"
                        class="h-[310px] overflow-auto flex w-fit flex-nowrap text-[22px] text-[#cacaca]"
                    >
                        ...
                        <svg width="0" height="0">
                            <defs>
                                ...
                                >
                                    <path
                                        d="M.235 0C.24 0 .56 0 .905 0V0C1.23 0 1.53 0 1.57 0 1.655 0 1.705 0 1.755.05 1.805.1 1.805.18 1.805.205 1.805.235 1.805.315 1.755.365 1.71.41 1.645.415 1.57.415 1.565.415 1.245.41.905.41V.41C.575.41.275.415.235.415.15.415.1.41.05.365-0 .315-0 .235-0 .205-0 .18-0 .095.05.05.095 0 .16 0 .235 0Z"
                                    />
                                </clipPath>
                            </defs>
                        </svg>
                        ...
                        <div class="w-[600px] h-[310px]">
                            <div class="w-[600px] h-[310px]"></div>
                        </div>
                        <!-- widget 1 -->
                        <div
                            class="mx-10 w-[330px] text-[rgba(0,0,0,0.88)] pt-5 flex items-end rounded-xl font-['Poppins'] font-light tracking-wide"
                        >
                            <div
                                class="w-[330px] text-[13px] font-['Poppins'] text-[#b5b5b5] tracking-wide"
                            >
                                <div class="flex items-center pt-5">
                                    ...
                                    <div
                                        class="flex flex-col min-w-0 max-w-[292px]"
                                    >
                                        <div
                                            class="ml-3 py-3 px-5 max-w-fit truncate bg-[#121212] rounded-t-full rounded-br-full"
                                        >
                                            Maybe CVR for last 6 months?
                                        </div>
                                        <div
                                            class="flex justify-start pr-[12px] text-[#7979798f] text-[12px]"
                                        >
                                            <div
                                                class="pl-7 flex justify-start"
                                            >
                                                @andywhite
                                            </div>
                                            <div
                                                class="pl-4 flex justify-start"
                                            >
                                                6min ago
                                            </div>
                                        </div>
                                ...
                                <div class="flex items-center pt-5">
                                    ...
                                    >
                                        <div
                                            class="ml-3 py-3 px-5 max-w-fit truncate bg-[#121212] rounded-t-full rounded-br-full"
                                        >
                                            Hi! There's something wired with the
                                            score now, if you look at the
                                        </div>
                                        <div
                                            class="flex justify-start pr-[12px] text-[#7979798f] text-[12px]"
                                        >
                        ...
                        <!-- widget 2 -->
                        <div
                            class="mx-10 max-w-[315px] min-w-[315px] gap-x-3 gap-y-2 h-[310px] text-[#b9b9b9] text-[16px] flex flex-wrap-reverse"
                        >
                            <!-- Item 1 -->
                            <div
                                class="bg-[#040b3c] h-[150px] w-[150px] squircle flex justify-between"
                            >
                                <div
                                    class="h-[150px] pt-6 pl-6 pb-6 pr-6 flex flex-col justify-between"
                                >
                                    <div
                                        class="flex justify-between items-start"
                                    >
                                        <div
                                            class="h-[78px] flex items-end max-w-[80px] text-[#fa71cccb] text-[16px]"
                                        >
                                            <span class="leading-[19px] pr-2">
                                                Quarterly stats screen
                                            </span>
                                        </div>
                                        <div class="w-7 flex justify-end">
                                            <svg
                                                class="w-7 h-7 transform -rotate-90 -translate-y-[2px]"
                                                xmlns="http://www.w3.org/2000/svg"
                                                viewBox="-1 -1 34 34"
                                            >
                                                <circle
                                    ...
                                    <div
                                        class="w-full text-[11px] tracking-widest text-[#2c3e78] flex items-start"
                                    >
                                        <span
                                            class="h-[17px] transform -translate-y-[5px]"
                                        >
                                            SALES
                                        </span>
                                    </div>
                            ...
                            <!-- Item 2 -->
                            <div
                                class="bg-[#043c367b] h-[150px] w-[150px] squircle flex justify-between"
                            >
                                <div
                                    class="h-[150px] w-[150px] pt-6 pl-6 pb-6 pr-6 flex flex-col justify-between"
                                >
                                    <div
                                        class="flex justify-between items-start"
                                    >
                                        <div
                                            class="h-[78px] flex items-end max-w-[80px] text-[#b76c0af9] text-[16px]"
                                        >
                                            <span class="leading-[19px] pr-">
                                                Brand metrics vs competition
                                            </span>
                                        </div>
                                        <div class="w-7 flex justify-end">
                                            <svg
                                    ...
                                    <div
                                        class="w-full text-[11px] tracking-widest text-[#0c675eaa] flex items-start"
                                    >
                                        <span
                                            class="h-[17px] transform -translate-y-[5px]"
                                        >
                        ...
                        <div class="mx-10 w-[310px] h-[310px]">
                            <div
                                class="squircle w-[310px] h-[310px] bg-[#19011e] text-[#d488ce] text-[20px] pt-[40px] pb-[40px] pl-[40px] flex flex-col justify-between"
                            >
                                <div class="text-[17px] text-[#863f80]">
                                    #Insight
                                </div>
                                <div
                                    class="text-[30px] tracking-normal leading-[40px] pr-5"
                                >
                                    Company OKRs 2023
                                </div>
        ...
        <div class="backdrop-blur-md bg-[#0f0f0f] rounded-t-[80px]">
            <!-- 1st board section -->
            <div
                class="rounded-t-[80px] text-5xl font-['Trap-Medium'] h-[200px] flex justify-start items-center pl-20"
            >
                Marketing
            </div>
            <masonry-wall
                ...
                :ssr-columns="1"
                :column-width="masonrysettings.width"
                :gap="masonrysettings.gap"
            >
            ...
            <div
                class="text-5xl font-['Trap-Medium'] h-[200px] flex justify-start items-center pl-20"
            >
                Sales
            </div>
            <masonry-wall
                v-if="salesitems.length > 1"
                class="px-20 pb-10 bg-[rgba(0,0,0,0.27)]"
                :items="salesitems"
                :ssr-columns="3"
                :column-width="500"
                :gap="16"
            >
                <template #default="{ item, index }">
                    <div
                        class="text-white bg-gray-900 rounded-xl p-10"
                        :style="{ height: `${item.height}px` }"
                    >
                        <h1>{{ item.title }}</h1>
                        <span>{{ item.description }}</span>
            ...
            <div v-else class="w-full px-20 pb-10">
                ...
                <button
                    class="dashed text-gray-900 text-5xl font-['Trap-Medium'] bg-transparent rounded-xl p-10 h-[250px] lg:w-[30%] flex justify-center items-center"
                >
                    Add
                </button>
            </div>
...
<script setup>
    ...
    console.log(`home.vue --> userStore userObject myUserId = ${myUserId}`)

    const firebaseUser = useFirebaseUser()
    console.log(
        `--> home.vue firebaseUser from useFirebaseUser: ${JSON.stringify(
            firebaseUser,
            null,
            3
        )}`
    ...
    onMounted(async () => {
        ...
        console.log(
            `---> home.vue -- userData: ${JSON.stringify(userData, null, 4)}`
        )
        console.log(
            `---> home.vue -- userData.name: ${JSON.stringify(
                userData.name,
                null,
                4
            )}`
        ...
        console.log(
            `---> home.vue -- userData.photoURL: ${JSON.stringify(
                userData.photoURL,
                null,
                4
            )}`
        ...
        console.log(
            `scrollcenter.value.scrollLeft ${scrollcenter.value.scrollLeft}`
        )
        console.log(
            `scrollcenter.value.scrollWidth ${scrollcenter.value.scrollWidth}`
        )
        console.log(
            `scrollcenter.value.offsetWidth ${scrollcenter.value.offsetWidth}`
        )
        console.log(
            `scrollcenter.value.getBoundingClientRect().width ${
                scrollcenter.value.getBoundingClientRect().width
            }`
        )
        ...
        let initialOffset =
            (scrollcenter.value.getBoundingClientRect().width -
                scrollcenter.value.scrollWidth) /
            2
